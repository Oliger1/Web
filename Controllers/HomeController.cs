...
namespace WebOliger.Controllers
{
    public class HomeController : Controller
    {
        ...
        {
            if (username == "Oliger" && password == "Oliger12")
            {
                // Lejo hyrjen në faqen e adminit
                return RedirectToAction("Admin", "Home");
            }
            else
            {
                // Mesazh për gabim në hyrje
                ViewBag.ErrorMessage = "Kombinimi i emrit të përdoruesit dhe fjalekalimit është i pasaktë.";
                return View("Login"); // ose kthehu në një faqe tjeter për hyrjen
            }
        }
